...
public class Department extends JFrame implements ActionListener {
    ...
    Department() {
        ...
        title.setBounds(80, 18, 400, 30);
        title.setFont(new Font("Segoe UI", Font.BOLD, 26));
        title.setForeground(Color.WHITE);
        headerPanel.add(title);

        JLabel subtitle = new JLabel("View and manage hospital departments");
        ...
        refreshBtn = createButton("🔄 Refresh", 650, 18, 120, 38, SUCCESS_COLOR);
        ...
        setTitle("Department Information - Hospital Management System");
        setSize(915, 780);
